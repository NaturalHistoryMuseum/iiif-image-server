...
Hi! Thanks for considering contributing to iiif-image-server. :sauropod:
...
- [Issues](https://github.com/NaturalHistoryMuseum/iiif-image-server/issues)
...
- [The documentation](https://iiif-image-server.readthedocs.io)
- [The existing issues](https://github.com/NaturalHistoryMuseum/iiif-image-server/issues?q=is:issue)
...
Our documentation is generated using [MkDocs](https://www.mkdocs.org), then hosted on [Read the Docs](https://about.readthedocs.com). You can view the current documentation for this repository at [iiif-image-server.readthedocs.io](https://iiif-image-server.readthedocs.io).
